...
class Dense2SparseRewriteActionTest : public HiveConnectorTestBase {
 public:
  Dense2SparseRewriteActionTest() {
  ...
  void testDense2SparsePlan(bool rewrite) {
    ...
    if (rewrite) {
      ...
      std::pair<std::string, std::string> testAction =
          std::make_pair("mat_mul0(ROW[\"v\"])", "Dense2SparseRewriteAction");
...
int main(int argc, char** argv) {
  ...
  Dense2SparseRewriteActionTest demo;
